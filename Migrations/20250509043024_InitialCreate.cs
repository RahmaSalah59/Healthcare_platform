        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Nutritionists_AspNetUsers_Id",
                        column: x => x.Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientNutritionists", x => new { x.PatientId, x.NutritionistId });
                    table.ForeignKey(
                        name: "FK_PatientNutritionists_Nutritionists_NutritionistId",
                        column: x => x.NutritionistId,
                        principalTable: "Nutritionists",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PatientNutritionists_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientTrainers", x => new { x.PatientId, x.TrainerId });
                    table.ForeignKey(
                        name: "FK_PatientTrainers_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PatientTrainers_Trainers_TrainerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientNutritionists_NutritionistId",
                table: "PatientNutritionists",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientTrainers_TrainerId",
                table: "PatientTrainers",
                column: "TrainerId");
